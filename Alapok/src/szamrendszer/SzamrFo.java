//HASZNÁLAT:
//a görgõvel és a két kis fehér résszel lehet száámrendszert választanni(2-20)
//a számot a billenytûzeten lévõ számok megnomásával lehet beírni
...
public class SzamrFo extends JFrame{
	...
	public SzamrFo() {
		 setTitle("Számrendszer - Horváth Dávid");
		setSize(810, 425);
